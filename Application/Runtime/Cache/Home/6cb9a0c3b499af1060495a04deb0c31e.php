  ...
  <div class="rightbox box">
    <h2>留言板</h2>
	 ...
	 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="notebox">
	    <div class="noteuser"><span class="notename"><script type="text/javascript">if("<?php echo ($vo["name"]); ?>"=="")document.write("匿名用户");else document.write("<?php echo ($vo["name"]); ?>");</script>:</span><p class="notetime"><?php echo (date("Y-m-d i:s",$vo["time"])); ?></p></div>
